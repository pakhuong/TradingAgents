...
# (forex/CFD symbols like XAUUSD+), and colon for exchange-qualified symbols
# like HOSE:GVR. The helper percent-encodes valid ticker characters that are
# not portable path characters, so the ticker never escapes a containing
# directory.
